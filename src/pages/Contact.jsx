    ...
    >
      ...
      <div className="contact-container">
        <div className="contact">
          ...
          <h1 className="contact-title title">𑣲Come try our frosty treats⟢</h1>
        ...
        <p className="divider text-center py-6.5 pt-12">˚₊‧꒰ა ♡ ໒꒱ ‧₊˚</p>

       
        <div className="socials">
          {/* <div className="tilt social-bg"></div> */}
          <h1 className="social-title title">Keep up with our flavours:</h1>
